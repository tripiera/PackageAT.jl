...
```
Ce code gère les erreurs que l'utilisateur pourrait faire en tappant pour s'assurer que tout ce qu'il tape correspond bien au type des variables de Utilisateur.
