...
Une fois toutes les questions répondues, le programme compare les scores lettre par lettre :
...
Trois nouvelles questions de préférence sont proposées, basées sur ces compatibilités. L’utilisateur peut soit choisir une option, soit laisser le hasard décider.

Le type compatible choisi est affiché, puis enregistré dans un second fichier texte.

Enfin, la fonction retourne :

Le MBTI de l’utilisateur

Le MBTI compatible sélectionné
